...
<div class="admin-grid-2">
  ...
  <div class="admin-card">
    ...
    <p class="amuted">ખાલી રાખો તો default generate થાય છે.</p>
    <form method="post">
      <?= Security::csrfField() ?>
    ...
    <form method="post">
      ...
      <a class="abtn" href="<?= $e(App::url('/sitemap.xml')) ?>" target="_blank" rel="noopener">👁 Sitemap જુઓ</a>
    </form>
  </div>
</div>
...
<div class="admin-card">
  ...
  <form method="post" class="filter-row">
    ...
    <input type="text" name="to_url" placeholder="/new-url અથવા https://..." required>
    <select name="redirect_type"><option value="301">301</option><option value="302">302</option></select>
    <button class="abtn abtn-primary" type="submit">+ ઉમેરો</button>
  </form>
  <table class="atable">
